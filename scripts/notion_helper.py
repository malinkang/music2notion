...
class NotionHelper:
    database_name_dict = {
        "SONG_DATABASE_NAME": "歌曲",
        "DAY_DATABASE_NAME": "日",
        "WEEK_DATABASE_NAME": "周",
        "MONTH_DATABASE_NAME": "月",
        "YEAR_DATABASE_NAME": "年",
        "ALBUM_DATABASE_NAME": "专辑",
        "SINGER_DATABASE_NAME": "歌手",
        "PLAYLIST_DATABASE_NAME": "歌单",
    }
    database_id_dict = {}
    image_dict = {}
    def __init__(self):
        ...
        self.song_database_id = self.database_id_dict.get(
            self.database_name_dict.get("SONG_DATABASE_NAME")
        )
        ...
        self.album_database_id = self.database_id_dict.get(
            self.database_name_dict.get("ALBUM_DATABASE_NAME")
        )
        self.singer_database_id = self.database_id_dict.get(
            self.database_name_dict.get("SINGER_DATABASE_NAME")
        )      
        self.playlist_database_id = self.database_id_dict.get(
            self.database_name_dict.get("PLAYLIST_DATABASE_NAME")
        )
